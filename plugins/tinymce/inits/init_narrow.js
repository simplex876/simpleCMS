...
//	convert_urls: false,
    ...
    plugins: ["autosave advlist autolink lists link image media charmap print preview hr anchor pagebreak searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media nonbreaking nospace save table contextmenu directionality emoticons template paste textcolor colorpicker textpattern importcss help"
    ],
...
*/
    ...
    menu: {
        ...
        insert: {title: "Insert", items: "image link anchor | charmap hr nonbreaking nospace"},
        view: {title: "View", items: "code fullscreen | visualaid visualblocks visualchars"},
        table: {title: "Table", items: "inserttable tableprops deletetable | cell row column"}
    },
    menubar: "edit format insert view table tools help",
    toolbar: "save code fullscreen | formatselect | fontselect fontsizeselect | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | emoticons hr nonbreaking nospace | help"
};