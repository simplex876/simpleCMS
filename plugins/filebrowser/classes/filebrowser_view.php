...
<div style="clear: both; width: 240px; float: left; padding-top: 6px;">' . substr($file,0,14);
				...
				if(preg_match('/.jpg|.jpeg|.png|.webp|.avif|.gif/i',$file))
				{
...
' . round(filesize($this->basePath . $this->currentDirectory . $file) / 1024, 0) . '&nbsp;kb';
			...
			else // list view
			{
				...
				if ((strpos($this->linkParams, 'type=images') !== FALSE && getimagesize($dir . $file)) || preg_match('/.jpg|.jpeg|.png|.webp|.avif|.gif/i',$file)) 
				{
